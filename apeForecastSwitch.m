...
% - more closely examines single change cases
...
% Define a scenario
swtype = 0; % downward swing is 0
swht = 1.5; % height of swing
swpt = 3/4; % switch time is nday*swpt
...
while Iwarn
    [Iday, Lam, Rtrue, tday, Iwarn] = epiSimSwitch(length(tday), 1, swtype, swht, swpt);
end
if Iwarn
