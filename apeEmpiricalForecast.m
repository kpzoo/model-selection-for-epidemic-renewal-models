...
saveFol = 'empirical data'; 
loadFol = 'EpiEstim data';
%loadFol = 'EpiEstim test';

% Define dataset scenarios 
scenNam = {'flu', 'sars', 'meas', 'pox'};
scenNo = 1; scen = scenNam{scenNo};
...
Iday0 = csvread(['I' idfil]); Iday0 = Iday0';
% Discretised serial distribution 
wday = csvread(['gen' idfil]); wday = wday';
% Total infectiousness 
Lam0 = csvread(['L' idfil], 1); 
Lam0 = [0; Lam0]; % first val is NA
Lam0 = Lam0';
